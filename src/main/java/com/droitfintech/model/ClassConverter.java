...
public abstract class ClassConverter<T> {
    ...
    private static Logger log = LoggerFactory.getLogger(ClassConverter.class);
    ...
    private static Map<Class<?>, ClassConverter<?>> CONVERTERS =
            new HashMap<Class<?>, ClassConverter<?>>(){{
                ...
                put(TradingWeekHoursSet.class, new TradingWeekHoursSetClassConverter());
                put(ProductMaster.class, new ProductMasterClassConverter());
